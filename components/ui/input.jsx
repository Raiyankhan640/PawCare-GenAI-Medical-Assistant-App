  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-emerald-500 focus-visible:ring-emerald-500/30 focus-visible:ring-[3px] focus-visible:shadow-lg focus-visible:shadow-emerald-500/20",
        "hover:border-emerald-600/50 hover:shadow-md",
