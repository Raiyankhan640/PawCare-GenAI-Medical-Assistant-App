class Chatbot {
    ...
    async sendMessage() {
        ...
        const imgName = this.currentImageName;
        ...
        try {
            ...
            if (hasImage) {
                // ? Option B: skip intent detection when image is present
...
`;
            ...
            navigator.geolocation.getCurrentPosition(async (pos) => {
                try {
                    ...
                    const req = {
                        ...
                        language: "en",
                        locationBias: { center: pos.coords, radius: 8000 },
                        fields: ["displayName", "formattedAddress", "rating", "userRatingCount", "nationalPhoneNumber"]
                    };
    ...
    async getTextResponse(message) {
        ...
        const sys = "You are a veterinary assistant. Respond accurately and concisely.";
    ...
    /* ---------------- IMAGE RESPONSE (2.0 — working schema) ---------------- */
