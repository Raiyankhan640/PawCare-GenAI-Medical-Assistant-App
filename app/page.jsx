...
export default function Home() {
  return (
    <section className="bg-background">
      <div className="container mx-auto px-4 py-20 lg:py-28 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
        <div>
          <p className="inline-block bg-emerald-900/30 text-emerald-300 px-3 py-1 rounded-full text-sm mb-4">
            Pet healthcare made simple
          </p>
          ...
          <p className="mt-6 text-muted-foreground max-w-xl">
            Book appointments, get telemedicine consultations, and manage your
            pet's health records in one secure platform.
          </p>
          <div className="mt-8 flex items-center gap-4">
            <a
              href="/onboarding"
              className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-md"
            >
              Get Started
            </a>
            <a
              href="/doctors"
              className="inline-flex items-center gap-2 border border-border px-4 py-2 rounded-md text-sm"
            >
              Find a Vet
            </a>
          </div>
        ...
        <div className="relative h-[420px] lg:h-[520px] rounded-xl overflow-hidden">
          <Image
            src="/banner2.png"
            alt="Veterinarians consulting"
            fill
            priority
