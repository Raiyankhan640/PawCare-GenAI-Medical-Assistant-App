...
export default function PetChatError({ error, reset }) {
  useEffect(() => {
    // Log chat errors for debugging
    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-muted-foreground mb-6">
          We're having trouble connecting to the AI assistant. Please try again in a moment.
        </p>
